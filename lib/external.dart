...
class External extends StatefulWidget {
  final String type;
  External({Key key, this.type}) : super(key: key);
            ...
            child: Column(
              children: <Widget>[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: <Widget>[
                    Text("Name as per IC/Passport:", style: TextStyle(fontSize: font14)),
                  ],
                ),
                SizedBox(
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: <Widget>[
                    Text("Temperature(°C):", style: TextStyle(fontSize: font14)),
                  ],
                ),
                SizedBox(
                  height: ScreenUtil().setHeight(5),
                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(
                        child: Text(DateTime.now().toString().substring(
                            0, DateTime.now().toString().length - 7)),
                      ),
                    ],
                  ),
                ),
